...
def setTime():
    ...
    # os.system("say detecting vehicles, "+directionNumbers[(currentGreen+1)%noOfSignals])  # macOS only
    print("Detecting vehicles:", directionNumbers[(currentGreen+1)%noOfSignals])
